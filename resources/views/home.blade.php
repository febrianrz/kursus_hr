...
<style type="text/css">
	...
	@foreach(\App\Banner::get() as $banner)
		.carousel-item.items{{ $i }} {
			background: -webkit-linear-gradient(rgba(23, 22, 23, 0.2), rgba(23, 22, 23, 0.5)), url({{ url(Storage::url($banner->gambar)) }}) no-repeat;
			background: -moz-linear-gradient(rgba(23, 22, 23, 0.2), rgba(23, 22, 23, 0.5)), url({{ url(Storage::url($banner->gambar)) }}) no-repeat;
			background: -ms-linear-gradient(rgba(23, 22, 23, 0.2), rgba(23, 22, 23, 0.5)), url({{ url(Storage::url($banner->gambar)) }}) no-repeat;
			background: linear-gradient(rgba(23, 22, 23, 0.2), rgba(23, 22, 23, 0.5)), url({{ url(Storage::url($banner->gambar)) }}) no-repeat;
